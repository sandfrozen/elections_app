...
User.destroy_all
User.create!( name: 'Admin', surname: 'Adminadmi', email: 'admin@ad.pl', pesel: 40041440404, admin: true, password: 'adminmind') #1
...
ElectionType.create!( name: "Wybory Prezydenckie" ) #1
