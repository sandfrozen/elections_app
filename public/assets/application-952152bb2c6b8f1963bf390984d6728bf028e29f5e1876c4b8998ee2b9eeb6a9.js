...
(function() {
  $(document).on('page:change', function() {
    return $('#comments-link').click(function() {
      return $('#comments-link').fadeToggle();
    });
  });

  $(document).on('page:change', function() {
    return $("#my-checkbox").change(function() {
      return $("#my-checkbox").fadeToggle();
    });
  });
  ...
  $(document).ready(function() {
    return $(".btn-show-new").click(function() {
      return $(".new-election-type-form").toggle();
    });
  });

  $(document).ready(function() {
    return $("input[name='candidate']").change(function() {
      var count, maxAllowed;
      maxAllowed = parseInt($("#max-votes").val());
      count = $("input[name='candidate']:checked").length;
      if (count > maxAllowed) {
        $(this).prop("checked", false);
        if (maxAllowed === 1) {
          return alert('Możesz wybrać maksymalnie ' + maxAllowed + ' kandydata.');
        } else {
          return alert('Możesz wybrać maksymalnie ' + maxAllowed + ' kandydatów.');
        }
      }
    });
  });
