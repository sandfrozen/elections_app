...
class ElectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create election" do
    assert_difference('Election.count') do
      post elections_url, params: { election: { end: @election.end, info: @election.info, max_votes: @election.max_votes, name: @election.name, start: @election.start } }
    end
  ...
  test "should update election" do
    patch election_url(@election), params: { election: { end: @election.end, info: @election.info, max_votes: @election.max_votes, name: @election.name, start: @election.start } }
